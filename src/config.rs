...
pub use self::{
    ...
    model::{
        validated_sidebar_bounds, AgentPanelSortConfig, AutomaticTabNameSource, Config,
        ...
        TabBarPositionConfig, TabNumberDisplay, ToastClipboardPosition, ToastConfig, ToastDelivery,
    ...
    tab_theme::{TabTheme, TabThemeConfig},
